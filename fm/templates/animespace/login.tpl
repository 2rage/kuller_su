...
<div class="top-welcome left">
					<p>Приветствуем тебя, <b>Странник!</b></p> 
					<ul class="reset loginbox">
		<li class="loginbtn">
			<form method="post" action="">
				<div id="logform" class="radial">
					...
					<p><a class="log-in" id="logbtn" href="#" title="Войди в аккаунт">Войди в аккаунт</a>
					
					
					или <a class="sign_in" href="{registration-link}" title="Зарегистрируйся">Зарегистрируйся</a></p>
				</div>
