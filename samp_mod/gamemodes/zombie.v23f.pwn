...
//Имя мода
#define GM_NAME "KulleR.su | Zombie v.023f"
...
// ~~~~~~~~~ Выдача награды при достижении ЛВЛ на приглашенном друге ~~~~~~~~~~~~
...
/*8*/    {"Samp-Z(ombie) является стабильным из русскоговорящих серверов. Здесь играют люди разных полов, национальностей и мировоззрений. \n"},
...
new TrainingTerm_ListData[6][] = { // термины
/*0*/    {"Термины будут тут.  О медике:\n"},
...
/*0*/    {"Диалоги и команды будут тут.О медике:\n"},
/*1*/    {"После появления зомби число повреждений на войне резко увеличилось.\n"},
/*2*/    {"Военные люди увидели, что ранения часто влекут за собою смерть; ничтожная на вид рана приводит к обширному инфицированию.\n"},
/*3*/    {"Для всех необходимость во врачах стала очевидной, и, начиная с 2040 года в каждом большом отряде, имеются цирюльники,\n"},
/*4*/    {"фельдшера с помощниками и особые хирурги и врачи. Имеются особые способности это: сделать инъекцию и вакцину человеку.\n"},
...
#define MAX_CONNECTS_IS_ROW 20 // Максимум игроков с одного ип
...
public OnGameModeInit(){
	...
	new str[70];
	format(str,sizeof(str), "%s developed by BRICS", GM_NAME);
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	new params[128],str[156],cmd[128],idx;
...
*/
	...
	if(strcmp(cmd, "/acmd", true) == 0)
	{
         ...
         if(Player_AdminLevel[playerid] >= 4 )SendClientMessage(playerid,-1,"/map_spawnlist, /map_remove_spawn, /map_add_spawn, /map_goto_spawn, /map_replace_spawn, /map_set_vault");
	     return 1;
	}
