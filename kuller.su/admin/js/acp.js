...
var IPBACP = Class.create({
	...
	ajaxWithResultAsDialogue: function( url )
	{
		...
		new Ajax.Request( url, { method: 'get',
								 ...
								 onSuccess: function(t)
								 {
									if ( ! t.responseJSON )
									{
										acp.errorDialogue( 'К сожалению, возникла проблема при обработке запроса :(' );
									}
	...
	{
		content = "<h3>Ошибка</h3><div class='ajax-inline-error' style='height: 40px; text-align:center'><p class='ipsPad'>" + text + "</p></div>";
