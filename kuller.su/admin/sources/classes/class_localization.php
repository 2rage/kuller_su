...
class class_localization
{
    ...
    */	
	 ...
	 * @since	2.0
	 */
    public function getTime($date, $method='%H:%M')
    {
	 ...
	 */
	 public function changeLanguageUrl( $langId )
	 {
		...
		return ipsRegistry::getClass('output')->buildUrl( str_replace( '&', '&amp;', http_build_query( $params ) ) . "&amp;k={$this->member->form_hash}&amp;setlanguage=1&amp;cal_id={$this->request['cal_id']}&amp;langid={$langId}", 'public' );
	 }
