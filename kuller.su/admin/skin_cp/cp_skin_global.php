 ...
 * Last Updated: $Date: 2012-12-26 17:58:56 -0500 (Wed, 26 Dec 2012) $
 * </pre>
 *
...
$IPBHTML .= <<<HTML
	...
	<div id='app_bar'>
		<a class='right' id='edit_tabs' href='#' title="Здесь Вы можете изменить панель приложений">Изменить Вкладки</a>
...
$IPBHTML .= <<<HTML
	...
	<div id='footer' class='clear'>
		<a href='http://www.invisionpower.com'>IP.Board 3</a> &copy; {$year} IPS, Inc. &nbsp;&nbsp;|&nbsp;&nbsp; <a href='http://clientarea.ibresource.ru/' title='{$this->lang->words['gl_getsupport_title']}'>{$this->lang->words['gl_getsupport']}</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href='http://forums.ibresource.ru' target='_blank' title='{$this->lang->words['gl_resources_title']}'>{$this->lang->words['gl_resources']}</a>
HTML;
