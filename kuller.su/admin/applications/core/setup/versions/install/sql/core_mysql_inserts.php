...
(3, 'Сайт', '', '', 'input', 0, 0, 0, 1, 0, 0, '', 0, '', 1, 'style_extra/cprofile_icons/profile_website.gif', 'website'),
(4, 'ICQ', '', '', 'input', 0, 0, 0, 1, 0, 0, '', 0, '', 1, 'style_extra/cprofile_icons/profile_icq.gif', 'icq'),
(5, 'Пол', '', 'u=Не определился|m=Мужчина|f=Женщина', 'drop', 0, 0, 0, 1, 0, 0, '', 0, '', 2, '', 'gender'),
(6, 'Город', '', '', 'input', 0, 0, 0, 1, 0, 0, '', 0, '<span class=\'ft\'>{title}</span><span class=\'fc\'>{content}</span>', 2, '', 'location'),
(7, 'Интересы', '', '', 'textarea', 0, 0, 0, 1, 0, 0, '', 0, '', 2, '', 'interests'),
...
$INSERT[] = "INSERT INTO core_sys_lang VALUES(1, 'ru_RU.UTF-8', 'Русский (RU)', 1, 0, 1)";

$INSERT[] = "INSERT INTO titles (id, posts, title, pips) VALUES (1, 0, 'Новичок', '1');";
$INSERT[] = "INSERT INTO titles (id, posts, title, pips) VALUES (2, 10, 'Пользователь', '2');";
$INSERT[] = "INSERT INTO titles (id, posts, title, pips) VALUES (4, 30, 'Продвинутый пользователь', '3');";
...
VALUES(1, 'Пример плагина', 'Плагин, не требующий написания кода, но требующий настройки.', 'Invision Power Services, Inc', 'http://invisionpower.com', 'v1.0', 'default', ',3,4,6,', ',4,6,', 'a:5:{s:14:"required_input";a:1:{s:8:"video_id";s:13:"[^A-Za-z0-9_]";}s:10:"string_url";s:41:"http://www.youtube.com/watch?v={video_id}";s:12:"string_title";s:25:"#PAGE_TITLE# ({video_id})";s:13:"section_title";s:7:"YouTube";s:11:"section_url";s:22:"http://www.youtube.com";}', 1, 'core');
EOF;
$INSERT[] = <<<EOF
INSERT INTO rc_classes (onoff, class_title, class_desc, author, author_url, pversion, my_class, group_can_report, mod_group_perm, extra_data, lockd, app)
VALUES(1, 'Плагин форума', 'Плагин жалоб на сообщения и темы в форумах.', 'Invision Power Services, Inc', 'http://invisionpower.com', 'v1.0', 'post', ',1,2,3,4,6,', ',4,6,', 'a:1:{s:15:"report_supermod";i:1;}', 1, 'forums');
EOF;
$INSERT[] = <<<EOF
INSERT INTO rc_classes (onoff, class_title, class_desc, author, author_url, pversion, my_class, group_can_report, mod_group_perm, extra_data, lockd, app)
VALUES(1, 'Плагин личных сообщений', 'Плагин жалоб на личные сообщения', 'Invision Power Services, Inc', 'http://invisionpower.com', 'v1.0', 'messages', ',1,2,3,4,6,', ',4,6,', 'a:1:{s:18:"plugi_messages_add";s:5:"4";}', 1, 'members');
EOF;
$INSERT[] = <<<EOF
INSERT INTO rc_classes (onoff, class_title, class_desc, author, author_url, pversion, my_class, group_can_report, mod_group_perm, extra_data, lockd, app)
VALUES(1, 'Плагин пользовательских профилей', 'Плагин жалоб на профили пользователей', 'Invision Power Services, Inc', 'http://invisionpower.com', 'v1.0', 'profiles', ',1,2,3,4,6,', ',4,6,', 'N;', 1, 'members');
EOF;


$INSERT[] = "INSERT INTO rc_status VALUES(1, 'Новая', 1, 5, 1, 0, 1, 1);";
$INSERT[] = "INSERT INTO rc_status VALUES(2, 'Рассматривается', 1, 5, 0, 0, 1, 2);";
$INSERT[] = "INSERT INTO rc_status VALUES(3, 'Завершена', 0, 0, 0, 1, 0, 3);";
...
$INSERT[] = "INSERT INTO reputation_levels VALUES(1, -20, 'Очень плохой', '');";
$INSERT[] = "INSERT INTO reputation_levels VALUES(2, -10, 'Плохой', '');";
$INSERT[] = "INSERT INTO reputation_levels VALUES(3, 0, 'Обычный', '');";
$INSERT[] = "INSERT INTO reputation_levels VALUES(4, 10, 'Хороший', '');";
$INSERT[] = "INSERT INTO reputation_levels VALUES(5, 20, 'Очень хороший', '');";
...
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(3, 'Digg', 'digg', 1, 3, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(4, 'Del.icio.us', 'delicious', 1, 4, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(5, 'Вконтакте', 'vkontakte', 1, 5, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(6, 'Мемори', 'memori', 1, 6, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(7, 'БобрДобр', 'bobrdobr', 1, 7, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(8, 'Email', 'email', 1, 7, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(9, 'Google+', 'googleplusone', 1, 3, 1, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(10, 'Печать', 'print', 1, 10, 0, '*');";
$INSERT[] = "INSERT INTO core_share_links (share_id, share_title, share_key, share_enabled, share_position, share_canonical, share_groups) VALUES(11, 'Скачать', 'download', 1, 11, 0, '*');";
...
VALUES
	(1, 'Спам', 1, 0, 0, 'h', 0, 1),
	(2, 'Нецензурные выражения', 1, 0, 0, 'h', 0, 2),
	(3, 'Злоупотребление подписью', 1, 0, 0, 'h', 0, 3),
	(4, 'Асоциальное поведение', 1, 0, 0, 'h', 0, 4),
	(5, 'Черезмерный подъем тем', 1, 0, 0, 'h', 0, 5);";
