...
$SQL[] = "DROP TABLE IF EXISTS vkontakte_connect;";

$SQL[] = "ALTER TABLE members ADD vk_token TEXT NULL;";
$SQL[] = "ALTER TABLE profile_portal ADD vk_bwoptions INT UNSIGNED NOT NULL DEFAULT '0';";
