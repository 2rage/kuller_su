...
class version_upgrade
{
	...
	public function fixArchiveForums()
	{
		...
		/* Message */
		$this->registry->output->addMessage("{$_total} форумов со статусом 'архивный' переведено в форумы только для чтения....");
	...
	public function removeOldHooks()
	{
		...
		/* Message */
		$this->registry->output->addMessage("{$_total} устаревших хуков удалено....");
	...
	public function convertHooks()
	{
		...
		/* Message */
		$this->registry->output->addMessage("{$_total} хуков обновлено....");
