 ...
 * Last Updated: $Date: 2013-01-14 09:16:36 -0500 (Mon, 14 Jan 2013) $
 * </pre>
 *
 * @author 		$Author: mark $
...
class public_core_global_login extends ipsCommand
{
    ...
    public function loginForm( $message="", $replacement='' )
    {
		...
		if ( $serviceClick )
		{
			switch ($serviceClick)
			{
				...
				break;
				case 'vkontakte':
				    $this->registry->getClass('output')->silentRedirect( $this->settings['_original_base_url'] . "/interface/vkontakte/index.php?reg=1" );
				break;
			}
		}
	...
	public function doLogout( $check_key=true )
	{
		...
		IPSCookie::set( "member_id" , "0", 1, 0 );
		IPSCookie::set( "pass_hash" , "0", 1, 0 );
