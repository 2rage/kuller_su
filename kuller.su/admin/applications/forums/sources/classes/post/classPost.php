 ...
 * IP.Board v3.4.2
 * Moderator actions
 * Last Updated: $Date: 2013-01-17 11:32:03 -0500 (Thu, 17 Jan 2013) $
 * </pre>
...
class classPost
{
	...
	{ 
		if ( $topicTitle )
		{
			...
			/* Clean */
			if( $this->settings['etfilter_shout'] && mb_strtoupper($this->_topicTitle) == $this->_topicTitle )
			{
				if( function_exists('mb_convert_case') )
				{
					...
					{
						$this->_topicTitle = ucwords( mb_strtolower($this->_topicTitle) );
					}
				}
				else
				{
