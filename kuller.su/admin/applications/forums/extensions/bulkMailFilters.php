...
class bulkMailFilter_forums_posts extends bulkMailFilter
{
	...
	{	
		...
		$inputBox = ipsRegistry::getClass('output')->formSimpleInput( 'bmf_forums_posts_number', isset( $_POST['bmf_forums_posts_number'] ) ? $_POST['bmf_forums_posts_number'] : '' );
	...
	public function getMembers( $data )
	{
		...
		{
			case 'g':
				return array( 'where' => array( "(m.posts>{$data['number']})" ) );
				break;
