 ...
 * IP.Board v3.4.2
 * Forum management
 * Last Updated: $Date: 2013-01-15 12:48:15 -0500 (Tue, 15 Jan 2013) $
 * </pre>
 *
...
class admin_forums_forums_forums extends ipsCommand
{
	...
	public function showRules()
	{
		...
		$forum['_editor']	= $_editor->show( 'body', array( 'height' => 350, 'isHtml' => 1, 'autoSaveKey' => "forums-admin-r{$forum['id']}" ) );		
	...
	public function doRules()
	{
		...
		$rules = array( 
						...
						'rules_text'		=> IPSText::stripslashes( $text ),
