function checkform() {
	...
	{
		msg += 'Пользователи этой группы имеют доступ к Админцентру\n\n';
	}
	
	if ( isMod && isMod.checked == true )
	{
		msg += 'Пользователи этой группы являются супермодераторами.\n\n';
	}
	
	if ( msg != '' )
	{
		if( confirm( "Проверка безопасности\n--------------\nНазвание группы пользователей: " + $F('g_title') + "\n--------------\n\n" + msg + 'Это верно?' ) )
		{
			return true;
		}
		else
