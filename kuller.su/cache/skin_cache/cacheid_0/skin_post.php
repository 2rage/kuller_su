...
{
$count_81de72ed362125f7b137aba88f987926 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_81de72ed362125f7b137aba88f987926]['data'] = $data;
}
...
{
$count_26732e272e15f0c160a4725592ee188b = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_26732e272e15f0c160a4725592ee188b]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_26732e272e15f0c160a4725592ee188b]['form'] = $form;
}
...
{
$count_45ac8a5fbec4235e8192928dc721c733 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_45ac8a5fbec4235e8192928dc721c733]['data'] = $data;
}
...
{
$count_1741066f60dc3ac8ad9de42a89e53d5f = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_1741066f60dc3ac8ad9de42a89e53d5f]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__28af02e4625dbee4d279ebc71e3fe811($posts)."") : ("")) . "
<p class='submit'>
...
function __f__28af02e4625dbee4d279ebc71e3fe811($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_25d97443d6ebc0795b88d566a43d5b90 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_25d97443d6ebc0795b88d566a43d5b90]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_25d97443d6ebc0795b88d566a43d5b90]['type'] = $type;
$this->functionData['uploadForm'][$count_25d97443d6ebc0795b88d566a43d5b90]['stats'] = $stats;
$this->functionData['uploadForm'][$count_25d97443d6ebc0795b88d566a43d5b90]['id'] = $id;
$this->functionData['uploadForm'][$count_25d97443d6ebc0795b88d566a43d5b90]['forum_id'] = $forum_id;
}
