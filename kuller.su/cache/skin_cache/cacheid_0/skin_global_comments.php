...
{
$count_9b4fa9b5f948ddd942b6bd4faec74963 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_9b4fa9b5f948ddd942b6bd4faec74963]['r'] = $r;
$this->functionData['comment'][$count_9b4fa9b5f948ddd942b6bd4faec74963]['parent'] = $parent;
$this->functionData['comment'][$count_9b4fa9b5f948ddd942b6bd4faec74963]['settings'] = $settings;
}
...
{
$count_72bfb41f89e885602a8cfa31899b50b1 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_72bfb41f89e885602a8cfa31899b50b1]['r'] = $r;
$this->functionData['commentHidden'][$count_72bfb41f89e885602a8cfa31899b50b1]['parent'] = $parent;
$this->functionData['commentHidden'][$count_72bfb41f89e885602a8cfa31899b50b1]['settings'] = $settings;
}
...
{
$count_b2649270dfa5bbba078682465363854b = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_b2649270dfa5bbba078682465363854b]['comments'] = $comments;
$this->functionData['commentsList'][$count_b2649270dfa5bbba078682465363854b]['settings'] = $settings;
$this->functionData['commentsList'][$count_b2649270dfa5bbba078682465363854b]['pages'] = $pages;
$this->functionData['commentsList'][$count_b2649270dfa5bbba078682465363854b]['parent'] = $parent;
$this->functionData['commentsList'][$count_b2649270dfa5bbba078682465363854b]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__795b00cae65d3fb5ee227805733373e6($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__795b00cae65d3fb5ee227805733373e6($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b35db9bf8f79092dc7e1f4a3a537f7a6 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_b35db9bf8f79092dc7e1f4a3a537f7a6]['comment'] = $comment;
$this->functionData['form'][$count_b35db9bf8f79092dc7e1f4a3a537f7a6]['parent'] = $parent;
$this->functionData['form'][$count_b35db9bf8f79092dc7e1f4a3a537f7a6]['editor'] = $editor;
$this->functionData['form'][$count_b35db9bf8f79092dc7e1f4a3a537f7a6]['settings'] = $settings;
$this->functionData['form'][$count_b35db9bf8f79092dc7e1f4a3a537f7a6]['errors'] = $errors;
$this->functionData['form'][$count_b35db9bf8f79092dc7e1f4a3a537f7a6]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
