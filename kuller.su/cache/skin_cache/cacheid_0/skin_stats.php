...
{
$count_dbf751ff9bf87e4c1273a5b203f9c7af = is_array($this->functionData['group_strip']) ? count($this->functionData['group_strip']) : 0;
$this->functionData['group_strip'][$count_dbf751ff9bf87e4c1273a5b203f9c7af]['group'] = $group;
$this->functionData['group_strip'][$count_dbf751ff9bf87e4c1273a5b203f9c7af]['members'] = $members;
$this->functionData['group_strip'][$count_dbf751ff9bf87e4c1273a5b203f9c7af]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__230ac9bd34a34361e83d6a0d92c395b2($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__508bc21ea76bd2baa1c505a78be2adad($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7ce0ca4e770345ddabbf96b309bc5a10($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__230ac9bd34a34361e83d6a0d92c395b2($group="", $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((empty( $info['forums'] )) ? ("
							--
						") : ("" . ((count( $info['forums'] ) == 1) ? ("
								".$this->__f__508bc21ea76bd2baa1c505a78be2adad($group,$members,$pagination,$info)."							") : ("
								...
								".$this->__f__7ce0ca4e770345ddabbf96b309bc5a10($group,$members,$pagination,$info)."								</ul>
...
{
$count_4ef0650660feaddfac94c8102cdac1ed = is_array($this->functionData['top_posters']) ? count($this->functionData['top_posters']) : 0;
$this->functionData['top_posters'][$count_4ef0650660feaddfac94c8102cdac1ed]['rows'] = $rows;
}
...
<table class='ipb_table ipsMemberList'>
	...
	") : ("
				".$this->__f__a8da2810433cb2bdf5a73d540c50a490($rows)."	")) . "
</table>";
return $IPBHTML;
}


function __f__a8da2810433cb2bdf5a73d540c50a490($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0d9fab2cc220f1f595a9b39460e30a80 = is_array($this->functionData['top_reputation']) ? count($this->functionData['top_reputation']) : 0;
$this->functionData['top_reputation'][$count_0d9fab2cc220f1f595a9b39460e30a80]['members'] = $members;
}
...
$IPBHTML .= "<table class='ipb_table'>
	...
	") : ("
				".$this->__f__e39e31cc435b99f47d9d2927b9508764($members)."	")) . "
</table>";
return $IPBHTML;
}


function __f__e39e31cc435b99f47d9d2927b9508764($members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $members as $info )
...
{
$count_3f2dce80adb2c201e2ad16ef4139f463 = is_array($this->functionData['whoPosted']) ? count($this->functionData['whoPosted']) : 0;
$this->functionData['whoPosted'][$count_3f2dce80adb2c201e2ad16ef4139f463]['tid'] = $tid;
$this->functionData['whoPosted'][$count_3f2dce80adb2c201e2ad16ef4139f463]['title'] = $title;
$this->functionData['whoPosted'][$count_3f2dce80adb2c201e2ad16ef4139f463]['rows'] = $rows;
}
...
<div class='fixed_inner'>
	<table class='ipb_table'>
		...
		" . ((count($rows) AND is_array($rows)) ? ("
						".$this->__f__8fa7d048a3e2617ec0ad67680f8ba9db($tid,$title,$rows)."		") : ("")) . "
	</table>
</div>";
return $IPBHTML;
}
...
function __f__8fa7d048a3e2617ec0ad67680f8ba9db($tid=0, $title="", $rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
