...
$this->_funcHooks['includeMeta'] = array('ogCaveman','hasIdentifier','hasDescription','metaTagsInner','metaTags','metatags','ogCaveman','hasIdentifier','hasDescription','metaTags','metatags');
...
{
$count_283c85c9808800994dbbb3036f2a225a = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['html'] = $html;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['css'] = $css;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['items'] = $items;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_283c85c9808800994dbbb3036f2a225a]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__f37507af01c62f73e91f613bd29e36d3($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__f37507af01c62f73e91f613bd29e36d3($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_64f840d10653b0adb8f691aeef310c13 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_64f840d10653b0adb8f691aeef310c13]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__90aae4fdc4d3aeddc3cf6d53138b86ba($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__01c5b717612f699e461f40bfd75655cd($css)."") : ("")) . "";
return $IPBHTML;
}


function __f__90aae4fdc4d3aeddc3cf6d53138b86ba($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__01c5b717612f699e461f40bfd75655cd($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e0b06b1dac54e6d2e502b45084530f98 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_e0b06b1dac54e6d2e502b45084530f98]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__5d05d1323e77642e8a00df07efa47616($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__ccb9b8d9bbe17eacd786009ea833f168($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5d05d1323e77642e8a00df07efa47616($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__ccb9b8d9bbe17eacd786009ea833f168($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_7cee486fb2a86a8b791d0fcba3eaece6 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_7cee486fb2a86a8b791d0fcba3eaece6]['jsModules'] = $jsModules;
}
...
{
$count_6fe9098faa02a735bb6ffe807e1d9c5c = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_6fe9098faa02a735bb6ffe807e1d9c5c]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__b3964cf4ade887cd0ac6170ad3f93818($metaTags)."") : ("")) . "";
return $IPBHTML;
}


function __f__b3964cf4ade887cd0ac6170ad3f93818($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d7a7d49d1cabbc7b189014c9eabb5be4 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__ac38419b7212a6bcd15e793ff0b2b436()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__ac38419b7212a6bcd15e793ff0b2b436()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_18da4759ec89af833dff64a9226289c5 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_18da4759ec89af833dff64a9226289c5]['header_items'] = $header_items;
}
...
{
$count_82c6ecc7ab86eb9956bbdcabaad51edc = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_693febc5b31d7a1ee203ea3fb9c35dad = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_dc9be14db891b85a27dd874f2b1a124d = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_dc9be14db891b85a27dd874f2b1a124d]['data'] = $data;
}
...
{
$count_cebf417e74bf5c3b9fa9271c6af67e30 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_cebf417e74bf5c3b9fa9271c6af67e30]['work'] = $work;
$this->functionData['paginationTemplate'][$count_cebf417e74bf5c3b9fa9271c6af67e30]['data'] = $data;
}
...
{
$count_79af23ce1ec1fb4c969fd39a82f60780 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
...
{
$count_fb4e89262035c7d4404814fc334a34f5 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_fb4e89262035c7d4404814fc334a34f5]['links'] = $links;
$this->functionData['shareLinks'][$count_fb4e89262035c7d4404814fc334a34f5]['title'] = $title;
$this->functionData['shareLinks'][$count_fb4e89262035c7d4404814fc334a34f5]['url'] = $url;
$this->functionData['shareLinks'][$count_fb4e89262035c7d4404814fc334a34f5]['cssClass'] = $cssClass;
}
$IPBHTML .= "&nbsp;";
return $IPBHTML;
}
...
{
$count_ed3df2304780be63a8fc81988bf712ef = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_ed3df2304780be63a8fc81988bf712ef]['sig'] = $sig;
$this->functionData['signature_separator'][$count_ed3df2304780be63a8fc81988bf712ef]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_ed3df2304780be63a8fc81988bf712ef]['can_ignore'] = $can_ignore;
}
...
{
$count_642a456f5544e0643ac54ae135d61590 = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_642a456f5544e0643ac54ae135d61590]['member'] = $member;
}
...
{
$count_de9e35e50886407170086068ea109c84 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_de9e35e50886407170086068ea109c84]['author'] = $author;
$this->functionData['userInfoPane'][$count_de9e35e50886407170086068ea109c84]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_de9e35e50886407170086068ea109c84]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		" . (($author['custom_fields'] != "") ? ("
			".$this->__f__7cc2443bcb53ba1713065a609f656076($author,$contentid,$options)."		") : ("")) . "
	</ul>
...
function __f__768471a44ccc12d21f490fec16494665($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7cc2443bcb53ba1713065a609f656076($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__768471a44ccc12d21f490fec16494665($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_b434a4f3ee9871fd5c9af8ec7711ee5b = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_b434a4f3ee9871fd5c9af8ec7711ee5b]['member'] = $member;
}
...
{
$count_083e16c5ea90fa72fc847baaf4d4853e = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_083e16c5ea90fa72fc847baaf4d4853e]['warning'] = $warning;
$this->functionData['warnDetails'][$count_083e16c5ea90fa72fc847baaf4d4853e]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__e3ca4e37734d290c20ae82baee21b5bf($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__e3ca4e37734d290c20ae82baee21b5bf($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
