...
{
$count_f52e0645858846e0268399280de26b17 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_f52e0645858846e0268399280de26b17]['data'] = $data;
}
...
{
$count_2c8c0e00a2fb236d9058a35849ae7ca7 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_2c8c0e00a2fb236d9058a35849ae7ca7]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_2c8c0e00a2fb236d9058a35849ae7ca7]['form'] = $form;
}
...
{
$count_97bc8cde2df094d3d7a7783c4a7d3461 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_97bc8cde2df094d3d7a7783c4a7d3461]['data'] = $data;
}
...
{
$count_1f9f2cbf6820ac2819009f975883ed42 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_1f9f2cbf6820ac2819009f975883ed42]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__a2754320decc78d5e17ffcbb551424a6($posts)."") : ("")) . "
<p class='submit'>
...
function __f__a2754320decc78d5e17ffcbb551424a6($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ad6a2273ae6c259d2e53b65a3d0beed8 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_ad6a2273ae6c259d2e53b65a3d0beed8]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_ad6a2273ae6c259d2e53b65a3d0beed8]['type'] = $type;
$this->functionData['uploadForm'][$count_ad6a2273ae6c259d2e53b65a3d0beed8]['stats'] = $stats;
$this->functionData['uploadForm'][$count_ad6a2273ae6c259d2e53b65a3d0beed8]['id'] = $id;
$this->functionData['uploadForm'][$count_ad6a2273ae6c259d2e53b65a3d0beed8]['forum_id'] = $forum_id;
}
