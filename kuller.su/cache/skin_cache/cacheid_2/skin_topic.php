...
$this->_funcHooks['archiveStatusMessage'] = array('isAdminArchivedTop','isModArchived','isArchivedDone','isAdminArchived','isRestoring','isAdminArchivedTop','isModArchived','isArchivedDone','isAdminArchived','isRestoring');
...
{
$count_aa51643953bcb26a70d76e7c94ff83bf = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_aa51643953bcb26a70d76e7c94ff83bf]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_aa51643953bcb26a70d76e7c94ff83bf]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_aa51643953bcb26a70d76e7c94ff83bf]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_aa51643953bcb26a70d76e7c94ff83bf]['sharelinks'] = $sharelinks;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_424d140030db1a10531dc765b07090fb = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_424d140030db1a10531dc765b07090fb]['announce'] = $announce;
$this->functionData['announcement_show'][$count_424d140030db1a10531dc765b07090fb]['author'] = $author;
}
...
{
$count_40c2734694d81e758186c7f4c48fe9b5 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_40c2734694d81e758186c7f4c48fe9b5]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_40c2734694d81e758186c7f4c48fe9b5]['forum'] = $forum;
}
...
{
$count_85582a2714c7f9cd249425574703269d = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_09a92d4b68159d34a1d85193057755bf = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_09a92d4b68159d34a1d85193057755bf]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_09a92d4b68159d34a1d85193057755bf]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_09a92d4b68159d34a1d85193057755bf]['opts'] = $opts;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_22c3a97b0d1960a3333ccedd617287e1 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_22c3a97b0d1960a3333ccedd617287e1]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_22c3a97b0d1960a3333ccedd617287e1]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_22c3a97b0d1960a3333ccedd617287e1]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_22c3a97b0d1960a3333ccedd617287e1]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_22c3a97b0d1960a3333ccedd617287e1]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_22c3a97b0d1960a3333ccedd617287e1]['editPoll'] = $editPoll;
}
$IPBHTML .= "<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__fdf50fd1c9797654c3938f9e96831798($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__16799fea13019223d2bf6f2852dba12e($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fdf50fd1c9797654c3938f9e96831798($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__16799fea13019223d2bf6f2852dba12e($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_39fa68ff0baec52f70fb6c44ce0ba258 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_39fa68ff0baec52f70fb6c44ce0ba258]['post'] = $post;
$this->functionData['post'][$count_39fa68ff0baec52f70fb6c44ce0ba258]['displayData'] = $displayData;
$this->functionData['post'][$count_39fa68ff0baec52f70fb6c44ce0ba258]['topic'] = $topic;
$this->functionData['post'][$count_39fa68ff0baec52f70fb6c44ce0ba258]['forum'] = $forum;
}
...
{
$count_45f7c270f13987f1b1ad51a8eb179ad7 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_45f7c270f13987f1b1ad51a8eb179ad7]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_b52849ce54c5399fec0e2ae945a62a57 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_b52849ce54c5399fec0e2ae945a62a57]['title'] = $title;
$this->functionData['show_attachment_title'][$count_b52849ce54c5399fec0e2ae945a62a57]['data'] = $data;
$this->functionData['show_attachment_title'][$count_b52849ce54c5399fec0e2ae945a62a57]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__e61d8ed11a006b3c2b8f734455c31da8($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__e61d8ed11a006b3c2b8f734455c31da8($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0158a8751a0ea9afa575163c7b59ad2c = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_0158a8751a0ea9afa575163c7b59ad2c]['data'] = $data;
}
...
{
$count_d306377fb5d826be331ca98b359e2425 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_d306377fb5d826be331ca98b359e2425]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_d306377fb5d826be331ca98b359e2425]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_d306377fb5d826be331ca98b359e2425]['topic'] = $topic;
}
...
{
$count_ca363d1d4fcb3b6d82a0580eaf490116 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_ca363d1d4fcb3b6d82a0580eaf490116]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_ca363d1d4fcb3b6d82a0580eaf490116]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_ca363d1d4fcb3b6d82a0580eaf490116]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_ca363d1d4fcb3b6d82a0580eaf490116]['displayData'] = $displayData;
}
...
<div class='master_list'>
	...
	" . ((is_array( $post_data ) AND count( $post_data )) ? ("
		".$this->__f__e6f8bf64b0432cf82946854f4b10db98($forum,$topic,$post_data,$displayData)."	") : ("")) . "
	...
	") : ("")) . "
		...
		<div style='text-align:center'>
			...
			<div id='mobileModOptions' style='display:none'>
				".$this->__f__b4bcfa0e6a34e5470623262ad241a248($forum,$topic,$post_data,$displayData)."			</div>
		</div>
	") : ("")) . "
	<div class='controls'>
		<div class='buttons'>
...
function __f__e6f8bf64b0432cf82946854f4b10db98($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b4bcfa0e6a34e5470623262ad241a248($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
