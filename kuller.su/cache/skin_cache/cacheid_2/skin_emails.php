...
{
$count_fa96445abcaae20cef8f3a706f0809c9 = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_fa96445abcaae20cef8f3a706f0809c9]['title'] = $title;
$this->functionData['forward_form'][$count_fa96445abcaae20cef8f3a706f0809c9]['text'] = $text;
$this->functionData['forward_form'][$count_fa96445abcaae20cef8f3a706f0809c9]['lang'] = $lang;
$this->functionData['forward_form'][$count_fa96445abcaae20cef8f3a706f0809c9]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_fa96445abcaae20cef8f3a706f0809c9]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__db1099512cd45ecc943f8f240028c214($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__db1099512cd45ecc943f8f240028c214($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
