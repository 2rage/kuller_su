...
{
$count_4e97bd2b21c7dbdfa9cdfbf7d06ad31f = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_4e97bd2b21c7dbdfa9cdfbf7d06ad31f]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_4e97bd2b21c7dbdfa9cdfbf7d06ad31f]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_4e97bd2b21c7dbdfa9cdfbf7d06ad31f]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_4e97bd2b21c7dbdfa9cdfbf7d06ad31f]['extraData'] = $extraData;
}
...
{
$count_f036a21cbe6766022e83a5af2fb01199 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['formField'] = $formField;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['content'] = $content;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['options'] = $options;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_f036a21cbe6766022e83a5af2fb01199]['showEditor'] = $showEditor;
}
...
{
$count_bb3a594bbd24c4b98bb303ceb44ccd7b = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_bb3a594bbd24c4b98bb303ceb44ccd7b]['options'] = $options;
$this->functionData['editorLoadJs'][$count_bb3a594bbd24c4b98bb303ceb44ccd7b]['inlineLoad'] = $inlineLoad;
}
...
{
$count_fca4dc6bac9e8afebbb2dede078aebf9 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_fca4dc6bac9e8afebbb2dede078aebf9]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_fca4dc6bac9e8afebbb2dede078aebf9]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_fca4dc6bac9e8afebbb2dede078aebf9]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_fca4dc6bac9e8afebbb2dede078aebf9]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__289f856b65ea8a4cb8de423807638fb3($rows,$pages,$app,$plugin)."		") : ("
...
function __f__289f856b65ea8a4cb8de423807638fb3($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_14cb4d83efb889b663b35a6050451cf7 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_14cb4d83efb889b663b35a6050451cf7]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__827556a345b633d49136954b7fe886eb($tabs)."			</ul>
		</div>
...
function __f__827556a345b633d49136954b7fe886eb($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
