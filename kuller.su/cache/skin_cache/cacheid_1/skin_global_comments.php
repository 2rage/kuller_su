...
{
$count_23b860aa4ff15220997b78aad10b4efb = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_23b860aa4ff15220997b78aad10b4efb]['r'] = $r;
$this->functionData['comment'][$count_23b860aa4ff15220997b78aad10b4efb]['parent'] = $parent;
$this->functionData['comment'][$count_23b860aa4ff15220997b78aad10b4efb]['settings'] = $settings;
}
...
{
$count_5a961012463277e117e6b92a2bdebdf0 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_5a961012463277e117e6b92a2bdebdf0]['r'] = $r;
$this->functionData['commentHidden'][$count_5a961012463277e117e6b92a2bdebdf0]['parent'] = $parent;
$this->functionData['commentHidden'][$count_5a961012463277e117e6b92a2bdebdf0]['settings'] = $settings;
}
...
{
$count_0508f31ceeb0b7d3e6a5593a6f91d6ab = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_0508f31ceeb0b7d3e6a5593a6f91d6ab]['comments'] = $comments;
$this->functionData['commentsList'][$count_0508f31ceeb0b7d3e6a5593a6f91d6ab]['settings'] = $settings;
$this->functionData['commentsList'][$count_0508f31ceeb0b7d3e6a5593a6f91d6ab]['pages'] = $pages;
$this->functionData['commentsList'][$count_0508f31ceeb0b7d3e6a5593a6f91d6ab]['parent'] = $parent;
$this->functionData['commentsList'][$count_0508f31ceeb0b7d3e6a5593a6f91d6ab]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__f674f1d21e79d3510f5fc2085fbd5738($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__f674f1d21e79d3510f5fc2085fbd5738($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e7ee6f0ff71318bd1a78595303f7aa2c = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_e7ee6f0ff71318bd1a78595303f7aa2c]['comment'] = $comment;
$this->functionData['form'][$count_e7ee6f0ff71318bd1a78595303f7aa2c]['parent'] = $parent;
$this->functionData['form'][$count_e7ee6f0ff71318bd1a78595303f7aa2c]['editor'] = $editor;
$this->functionData['form'][$count_e7ee6f0ff71318bd1a78595303f7aa2c]['settings'] = $settings;
$this->functionData['form'][$count_e7ee6f0ff71318bd1a78595303f7aa2c]['errors'] = $errors;
$this->functionData['form'][$count_e7ee6f0ff71318bd1a78595303f7aa2c]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
