...
/* CACHE FILE: Generated: Fri, 24 May 2013 02:04:41 GMT */
...
$this->_funcHooks['globalTemplate'] = array('showingapp','applications','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','didfirstappnowbottom','navigationlink','closenavigationlink','forsuredidfirstnavbottom','navigationbottom','isCoreRC','hideRcForPerms','fbcenabled','isLargeTouch','isSmallTouch','notifications','messengerlink','notifications','showInboxNotify','authenticating','updateTwitter','updateFacebook','update','canUpdateStatus','userLikeLink','nobbyNoMates','bloglink','pmLink','gallerylink','nexuslink','limFacebook','limTwitter','limWindows','memberbox','brandingBar','showhomeurl','applicationsloop','hasCustomPrimaryNavigation','didfirstnav','switchnavigation','viewnewcontentapp','siterulestitle','ruleslink','siteruleslink','showQuickNav','canSearch','showacplink','rclink','accessreports','hasHeaderAd','mainpageContent','hasFooterAd','didfirstnavbottom','switchnavigationbottom','countnavbottom','isTouchDevice','skinchangerInner','uagentlocked','skinchangerOuter','langchooser','markRead','privvy','lastvisit','isfloat','sqldebuglink','closesqldebuglink','showdebuglevel','includeLightboxDoReal');
...
" . (($this->settings['guestMessage']='no') ? ("") : ("")) . "
" . (($this->settings['navDropdown']='no') ? ("") : ("")) . "
" . (($this->settings['defaultMoreDropdown']='no') ? ("") : ("")) . "
" . (($this->settings['imageURL']='yes') ? ("") : ("")) . "
" . (($this->settings['customBackground']='yes') ? ("") : ("")) . "";
return $IPBHTML;
}
...
$IPBHTML = "";
$IPBHTML .= "" . (($this->settings['textLogo']=='yes') ? ("
<a href='{$this->settings['board_url']}' class='textLogo' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'>KulleR.su</a> 
") : ("
...
{
$count_902c4dc2fb1cba04f8f5a759bce52541 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['html'] = $html;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['css'] = $css;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['items'] = $items;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_902c4dc2fb1cba04f8f5a759bce52541]['stats'] = $stats;
}
...
$IPBHTML .= "<!DOCTYPE html>
	...
	<body " . (($this->settings['customBackground']=='yes') ? ("data-customBackground='enabled'") : ("")) . " id='ipboard_body'>
                    ...
                    <ul class='ipsList_inline'>
                        <li>
                            <span class='services'>
                                ...
                                ") : ("")) . "<!--hook.if.skin_global.globalTemplate.limTwitter.post.endif-->
		...
		<div id='primary_nav' class='clearfix'>
                <ul class='ipsList_inline' id='community_app_menu'>
                    ...
                    " . ((!empty($header_items['primary_navigation_menu'])) ? ("
                        ...
                        ".$this->__f__f3e629d675b1a69c9e8af2fd3c86460e($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."                    ") : ("")) . "")) . "
...
" . (($this->settings['navDropdown']=='yes') ? ("
            ...
            <div class='content'>
                ...
                <div id='secondary_navigation' class='clearfix'>
                    ...
                    <ol class='breadcrumb top ipsList_inline left' id='breadcrumb'>
                            ...
                            " . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
                        ".$this->__f__b88e35bbbd40684679d280d758401760($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."                    </ol>
                    <ul id='secondary_links' class='ipsList_inline right'>
                        ...
                        " . (($this->settings['gl_show'] and $this->settings['gl_title']) ? ("<li " . (($this->settings['gl_title']) ? ("data-tooltip=\"{$this->settings['gl_title']}\"") : ("data-tooltip=\"{$this->lang->words['board_rules']}\"")) . "><a href='" . (($this->settings['gl_link']) ? ("{$this->settings['gl_link']}") : ("" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=boardrules", "public",'' ), "", "" ) . "")) . "'><img src=\"{style_images_url}/nav_rules.png\" alt=\"\" /></a></li>") : ("")) . "
                        " . (($this->settings['customBackground']=='yes') ? ("<li id='nav_background' data-tooltip=\"Сменить фон\"><a href=\"#\"><img src='{style_images_url}/nav_background.png' alt='' /></a></li>") : ("")) . "" . (($this->memberData['g_use_search']) ? ("<li id='nav_search' data-tooltip=\"Поиск\"><a href=\"#\"><img src='{style_images_url}/nav_search.png' alt='' /></a></li>") : ("")) . "
                        ...
                        <li data-tooltip=\"{$this->lang->words['launch_quicknav']}\"><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=navigation&amp;inapp=" . IPS_APP_COMPONENT . "", "public",'' ), "", "" ) . "\" rel=\"quickNavigation\" accesskey='9' id='quickNavLaunch'><img src=\"{style_images_url}/icon_quicknav.png\" alt=\"\" /></a></li>
                        ") : ("")) . "
                        " . (($this->settings['showFacebook']=='yes') ? ("
                        <li data-tooltip=\"Visit us on Facebook\"><a href=\"http://www.facebook.com/{$this->settings['facebookName']}\"><img src=\"{style_images_url}/social_facebook.png\" alt=\"\" /></a></li>
                        ") : ("")) . "" . (($this->settings['showTwitter']=='yes') ? ("
                        <li data-tooltip=\"Follow us on Twitter\"><a href=\"http://twitter.com/#!/{$this->settings['twitterName']}\"><img src=\"{style_images_url}/social_twitter.png\" alt=\"\" /></a></li>
                        ") : ("")) . "" . (($this->settings['showYoutube']=='yes') ? ("
                        <li data-tooltip=\"Watch us on YouTube\"><a href=\"http://www.youtube.com/user/{$this->settings['youtubeName']}\"><img src=\"{style_images_url}/social_youtube.png\" alt=\"\" /></a></li>
                        ") : ("")) . "
                    </ul>
                
                </div>
                
                " . (($this->memberData['g_use_search']) ? ("<div id='toggle_search'>" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'quickSearch' ) ? $this->registry->getClass('output')->getTemplate('global')->quickSearch() : '' ) . "</div>") : ("")) . "
                " . (($this->settings['customBackground']=='yes') ? ("<div id='toggle_background'><div id='custom_background'>
                ...
                " . (($this->settings['imageURL']=='yes') ? ("<div id='custom_url'><input type='text' id='custom_input' placeholder=\"Или вставьте ссылку Вашего фона и нажмите на кнопку Сменить\" /><strong id='custom_submit'>Сменить</strong></div>") : ("")) . "
                </div></div>") : ("")) . "
			...
			<div id='content' class='clearfix'>
				...
				") : ("")) . "
				" . (($html) ? ("<!--hook.if.skin_global.globalTemplate.mainpageContent.post.startif-->{$html}<!--hook.if.skin_global.globalTemplate.mainpageContent.pre.endif-->") : ("")) . "
				" . (($items['adFooterCode']) ? ("
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__4ed4b9b4d6fef39da611cf73e44baa00($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
				</ol>
			</div>
						...
						" . ((count($footer_items['skin_chooser']) > 1) ? ("
							<li>
								...
								<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
									".$this->__f__bfc51ec637239dc4e8b7663b020482f1($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</ul>
							</li>
						") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__c361916bff864792efdffb8bf6c8d69e($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__f6c1ce9f55b96f9302f3c5ca09b653ac($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__f3e629d675b1a69c9e8af2fd3c86460e($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b88e35bbbd40684679d280d758401760($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4ed4b9b4d6fef39da611cf73e44baa00($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__bfc51ec637239dc4e8b7663b020482f1($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c361916bff864792efdffb8bf6c8d69e($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f6c1ce9f55b96f9302f3c5ca09b653ac($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e983cfc1fa7131eb49da54a0dcddeb3a = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_e983cfc1fa7131eb49da54a0dcddeb3a]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__289641a406333ff099c44b29dda1a487($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__00bf50094a1146cb2c4cd518cba45b14($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__289641a406333ff099c44b29dda1a487($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__00bf50094a1146cb2c4cd518cba45b14($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d070fd6e60938e4d26bb18af2e344ba3 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_d070fd6e60938e4d26bb18af2e344ba3]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__adb3e8b5a24903d298bef8b5b10df95f($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__b75aac832176352c68b1d264b09ac4b8($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__adb3e8b5a24903d298bef8b5b10df95f($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__b75aac832176352c68b1d264b09ac4b8($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_8f280ed5be2b2b261f7a76c518a2f791 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_8f280ed5be2b2b261f7a76c518a2f791]['jsModules'] = $jsModules;
}
...
{
$count_e4383a6271474ad19a8ebe74577280f5 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_e4383a6271474ad19a8ebe74577280f5]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__4366b3c0dfafb376338078afbfaf890d($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__d2dee8c8f99bafa79cf026cbacf3bc1f($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4366b3c0dfafb376338078afbfaf890d($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__d2dee8c8f99bafa79cf026cbacf3bc1f($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_67c8be3d4c0d28a71bcd483f4a69ea75 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__6e995592e59c89bcd437292bfa3b792a()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__6e995592e59c89bcd437292bfa3b792a()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7d9d9ec7b425c6308888594eb53ed05b = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_7d9d9ec7b425c6308888594eb53ed05b]['header_items'] = $header_items;
}
...
{
$count_3adda8ee4946daf6d9c39ccb6d3bf879 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
...
{
$count_c5e4f521d741ba2fb02b79fb3ef018c9 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__a5723612e7673011d70c4f5e4d16e1ea($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__a5723612e7673011d70c4f5e4d16e1ea($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_4578fb4fb678773f5e9ba1e8b5f45a81 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_4578fb4fb678773f5e9ba1e8b5f45a81]['data'] = $data;
}
...
{
$count_7aef2b315355263d232bbe5eddd37659 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_7aef2b315355263d232bbe5eddd37659]['work'] = $work;
$this->functionData['paginationTemplate'][$count_7aef2b315355263d232bbe5eddd37659]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__b4a1be44f9966e8d86335c51bdd802f6($work,$data)."			") : ("")) . "
		</ul>
...
function __f__b4a1be44f9966e8d86335c51bdd802f6($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_36178cb1d64eb97d926894cffc7caaae = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
$IPBHTML .= "<div id='search'>
			...
			<span id='search_wrap'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					" . (($this->request['showtopic']) ? ("
						<li class='special'><label for='s_topic' title='{$this->lang->words['context_search_topic']}'><input type='radio' name='search_app' value=\"forums:topic:{$this->request['showtopic']}\" class='input_radio' id='s_topic' checked=\"checked\" /> <strong>{$this->lang->words['context_search_topic']}</strong></label></li>
					") : ("")) . "
					" . ((( $this->request['showforum'] AND $this->registry->getClass('class_forums')->forum_by_id[ $this->request['showforum'] ]['sub_can_post'] ) || $this->request['showtopic']) ? ("<li class='special'><label for='s_forum' title='{$this->lang->words['context_search_forum']}'><input type='radio' name='search_app' value=\"forums:forum:{$this->request['f']}\" class='input_radio' id='s_forum' " . ((!$this->request['showtopic']) ? ("checked=\"checked\"") : ("")) . " /> <strong>{$this->lang->words['context_search_forum']}</strong></label></li>") : ("")) . "
...
function __f__b1402332c96a9e355fe0cf227a0ed16b()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
						" . ((IPSLib::appIsSearchable( $app, 'search' ) AND !in_array( $app, array( 'forums', 'members', 'core' ) )) ? ("<li class='app'><label for='s_{$app}' title='" . IPSLib::getAppTitle( $app ) . "'>
                                    ...
                                    " . IPSLib::getAppTitle( $app ) . "</label></li>") : ("")) . "
...
{
$count_51503f824537ceb3cc332e6c489008f8 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_51503f824537ceb3cc332e6c489008f8]['links'] = $links;
$this->functionData['shareLinks'][$count_51503f824537ceb3cc332e6c489008f8]['title'] = $title;
$this->functionData['shareLinks'][$count_51503f824537ceb3cc332e6c489008f8]['url'] = $url;
$this->functionData['shareLinks'][$count_51503f824537ceb3cc332e6c489008f8]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__bc3b7f641fa4d3b4c463f0c9a9f0942a($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__bc3b7f641fa4d3b4c463f0c9a9f0942a($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0affa41801ccd1a2b0c68780cf7e2954 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_0affa41801ccd1a2b0c68780cf7e2954]['sig'] = $sig;
$this->functionData['signature_separator'][$count_0affa41801ccd1a2b0c68780cf7e2954]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_0affa41801ccd1a2b0c68780cf7e2954]['can_ignore'] = $can_ignore;
}
...
{
$count_8af37f0f2d4dc996e8086729bf8121e3 = is_array($this->functionData['tbSruiHook']) ? count($this->functionData['tbSruiHook']) : 0;
$this->functionData['tbSruiHook'][$count_8af37f0f2d4dc996e8086729bf8121e3]['author'] = $author;
}
...
$IPBHTML .= "<div style='margin:5px auto;min-width:80px;' class='reputation {$tbSruiStyle}' data-tooltip=\"{$this->lang->words[ $likesMode ]}\">
	...
	" . ((!empty($author['author_reputation']['text']) || !empty($author['author_reputation']['image'])) ? ("-
...
{
$count_c868d955777b20d0587be6727e460ad8 = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_c868d955777b20d0587be6727e460ad8]['member'] = $member;
}
...
{
$count_cd8ad0fb35de34fa6ec8888ade87adad = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_cd8ad0fb35de34fa6ec8888ade87adad]['author'] = $author;
$this->functionData['userInfoPane'][$count_cd8ad0fb35de34fa6ec8888ade87adad]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_cd8ad0fb35de34fa6ec8888ade87adad]['options'] = $options;
}
...
" . ((($this->settings['horizontalTopicView']=='yes') AND $this->request['section'] == 'topics') ? ("<div class='horizontalAvatar left'>
    ...
    <ul class='custom_fields' style='width: 140px;'>
	...
	<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("
		<ul class='horizontalInfoList custom_fields'>
			".$this->__f__5a3e1aec4af8e79d574de3de77f10656($author,$contentid,$options)."		</ul>
	") : ("")) . "
    ...
    <ul class='horizontalInfoList' style='float: right; width: 190px;'>
		...
		<li style='padding-left: 15px;'>Joined: " . $this->registry->getClass('class_localization')->getDate($author['joined'],"DATE", 0) . "</li>
    </ul>
	...
	<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("<ul class='custom_fields'>
			".$this->__f__f3668e0bea2509d76644de32b2af688f($author,$contentid,$options)."		" . (($author['member_id']) ? ("
		<li class='desc lighter blend_links'>
			<img src=\"http://kuller.su/public/style_extra/cprofile_icons/comment_new.png\"/><font color=\"#B22222\"><font size=\"2\">Сообщений: </font></font>" . $this->registry->getClass('class_localization')->formatNumber( intval( $author['posts'] ) ) . "
		</li>
		") : ("")) . "
		...
		" . (($author['show_warn']) ? ("<li>
				" . (($options['wl_id']) ? ("
					<img src='{$this->settings['img_url']}/warn.png' class='clickable' onclick='warningPopup( this, {$options['wl_id']} )' title='{$this->lang->words['warnings_issued']}' />
				") : ("")) . "
				<img src=\"http://kuller.su/public/style_extra/cprofile_icons/warn.png\" /><font color=\"#B22222\"> Предупреждений: </font><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=profile&amp;section=warnings&amp;member={$author['member_id']}&amp;from_app={$this->request['app']}&amp;from_id1={$contentid}&amp;from_id2={$options['id2']}", "public",'' ), "", "" ) . "' id='warn_link_{$contentid}_{$author['member_id']}' title='{$this->lang->words['warn_view_history']}'>" . sprintf($author['warn_level'] ) . "</a>
			</li>") : ("")) . "") : ("")) . "
		</ul>")) . "
...
function __f__73238ad648884116aa2fc1b39946cb61($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5a3e1aec4af8e79d574de3de77f10656($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__73238ad648884116aa2fc1b39946cb61($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
function __f__ed16be8961316c60004a0464c5792415($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'][ $group ] as $field )
...
function __f__f3668e0bea2509d76644de32b2af688f($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__ed16be8961316c60004a0464c5792415($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_9f61afdb0fca7dbd97254891cd1ecc66 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_9f61afdb0fca7dbd97254891cd1ecc66]['member'] = $member;
}
...
{
$count_4d80cd3f6ce302c88a486d922c8619f1 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_4d80cd3f6ce302c88a486d922c8619f1]['warning'] = $warning;
$this->functionData['warnDetails'][$count_4d80cd3f6ce302c88a486d922c8619f1]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__036bd955d08a64b33b178b498ecd9ea7($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__036bd955d08a64b33b178b498ecd9ea7($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
