...
{
$count_d7d3c5dad400fba33b81ca09893ed763 = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_d7d3c5dad400fba33b81ca09893ed763]['title'] = $title;
$this->functionData['forumAttachments'][$count_d7d3c5dad400fba33b81ca09893ed763]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_d7d3c5dad400fba33b81ca09893ed763]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__7e83603c204944931181cc963fe86934($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__7e83603c204944931181cc963fe86934($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f2e43d7d770d9c0c72c712ac8eb69dc4 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_f2e43d7d770d9c0c72c712ac8eb69dc4]['inforum'] = $inforum;
}
$IPBHTML .= "" . (($this->settings['customForumIcons']='no') ? ("") : ("")) . "
<!-- -->
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<div class='content_border'><table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__f4c77655d942acd7dcc5e40fccdc8a9f($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table></div>
	<br />	
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
		...
		<div class='ipsBox table_wrap removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__107b286d23b8402647c109bb1fc697bd($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__5d3a3afd0fbd0a0664b7bdb4ba3207aa($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr> 
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__a474c91ec995422f0a4eb52cdfe364e1($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
    ".$this->__f__99892a51fe0bb635773fc69bb5054058($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>";
return $IPBHTML;
}


function __f__f4c77655d942acd7dcc5e40fccdc8a9f($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2c1ace2b0767530079312e33c4f281d1($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a449edeea83a6980685dce12aa2cbf91($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
" . (($this->settings['customForumIcons']=='yes') ? ("															" . ((is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_images/' . $imageFolder . '/forum_images/' . $forumId . '.png' )) ? ("
												...
												</script>") : ("" . (($this->settings['customForumIcons']=='yes') ? ("															" . ((is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_images/' . $imageFolder . '/forum_images/' . $forumId . '.png' )) ? ("
										...
										<td class='col_c_forum'>									
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
													".$this->__f__2c1ace2b0767530079312e33c4f281d1($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
...
function __f__107b286d23b8402647c109bb1fc697bd($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__a449edeea83a6980685dce12aa2cbf91($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__5d3a3afd0fbd0a0664b7bdb4ba3207aa($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a474c91ec995422f0a4eb52cdfe364e1($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__99892a51fe0bb635773fc69bb5054058($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_78ec5aeeebddfa25ef6693a0fc650186 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_78ec5aeeebddfa25ef6693a0fc650186]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_78ec5aeeebddfa25ef6693a0fc650186]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_78ec5aeeebddfa25ef6693a0fc650186]['opts'] = $opts;
}
...
{
$count_c36840b5fdb690aec61e94d661050185 = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_c36840b5fdb690aec61e94d661050185]['data'] = $data;
$this->functionData['topic'][$count_c36840b5fdb690aec61e94d661050185]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_c36840b5fdb690aec61e94d661050185]['other_data'] = $other_data;
$this->functionData['topic'][$count_c36840b5fdb690aec61e94d661050185]['inforum'] = $inforum;
}
...
" . (($data['_answeredPid'] !== false) ? ("
		...
		") : ("")) . "
		" . ((! $inforum && $data['nav']) ? ("
            ".$this->__f__d3b4e1abd76573fe080194d206a2e165($data,$forum_data,$other_data,$inforum)."        ") : ("")) . "
        <h4>
            {$data['prefix']}
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__0e6126ec944fbc28dd8744232b8bc7a0($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "
	</td>
...
function __f__d3b4e1abd76573fe080194d206a2e165($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0e6126ec944fbc28dd8744232b8bc7a0($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_579a7709896bdd14744a0c7ef8bb682b = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_579a7709896bdd14744a0c7ef8bb682b]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__64a64d27e04aca67b85fc564bac9cff3($rating_id)."</span>";
return $IPBHTML;
}


function __f__64a64d27e04aca67b85fc564bac9cff3($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7d54e613ad32978b6b0a2bcfd10bedd3 = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_7d54e613ad32978b6b0a2bcfd10bedd3]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
