...
{
$count_222886cb8ae14d1f661b829ac7411ba3 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_222886cb8ae14d1f661b829ac7411ba3]['r'] = $r;
$this->functionData['comment'][$count_222886cb8ae14d1f661b829ac7411ba3]['parent'] = $parent;
$this->functionData['comment'][$count_222886cb8ae14d1f661b829ac7411ba3]['settings'] = $settings;
}
...
{
$count_8de8c2d2915c7a896861d573ce3693d2 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_8de8c2d2915c7a896861d573ce3693d2]['r'] = $r;
$this->functionData['commentHidden'][$count_8de8c2d2915c7a896861d573ce3693d2]['parent'] = $parent;
$this->functionData['commentHidden'][$count_8de8c2d2915c7a896861d573ce3693d2]['settings'] = $settings;
}
...
{
$count_081d44392315f743e494713367ecbe27 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_081d44392315f743e494713367ecbe27]['comments'] = $comments;
$this->functionData['commentsList'][$count_081d44392315f743e494713367ecbe27]['settings'] = $settings;
$this->functionData['commentsList'][$count_081d44392315f743e494713367ecbe27]['pages'] = $pages;
$this->functionData['commentsList'][$count_081d44392315f743e494713367ecbe27]['parent'] = $parent;
$this->functionData['commentsList'][$count_081d44392315f743e494713367ecbe27]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__ab4a2a975205df79f1b374dd25d9a474($comments,$settings,$pages,$parent,$preReply)."</div>
...
function __f__ab4a2a975205df79f1b374dd25d9a474($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_353c23b425fce89da5af9f1cc8cf195b = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_353c23b425fce89da5af9f1cc8cf195b]['comment'] = $comment;
$this->functionData['form'][$count_353c23b425fce89da5af9f1cc8cf195b]['parent'] = $parent;
$this->functionData['form'][$count_353c23b425fce89da5af9f1cc8cf195b]['editor'] = $editor;
$this->functionData['form'][$count_353c23b425fce89da5af9f1cc8cf195b]['settings'] = $settings;
$this->functionData['form'][$count_353c23b425fce89da5af9f1cc8cf195b]['errors'] = $errors;
$this->functionData['form'][$count_353c23b425fce89da5af9f1cc8cf195b]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
