...
{
$count_1a7123ad3965e02838b125ccfcaa2bc6 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_1a7123ad3965e02838b125ccfcaa2bc6]['data'] = $data;
}
...
{
$count_d0e5be17c4bb5fabced5735c303a69ba = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_d0e5be17c4bb5fabced5735c303a69ba]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_d0e5be17c4bb5fabced5735c303a69ba]['form'] = $form;
}
...
{
$count_40f9904011aaa3b621276cefd1739a31 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_40f9904011aaa3b621276cefd1739a31]['data'] = $data;
}
...
{
$count_0f0b06ddc13c84d5205e0281f88f75eb = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_0f0b06ddc13c84d5205e0281f88f75eb]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__ec602047b236180b7c3e50ae5eda9b6c($posts)."") : ("")) . "
<p class='submit'>
...
function __f__ec602047b236180b7c3e50ae5eda9b6c($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b66c92b672a22027f37ff73d252eef90 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_b66c92b672a22027f37ff73d252eef90]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_b66c92b672a22027f37ff73d252eef90]['type'] = $type;
$this->functionData['uploadForm'][$count_b66c92b672a22027f37ff73d252eef90]['stats'] = $stats;
$this->functionData['uploadForm'][$count_b66c92b672a22027f37ff73d252eef90]['id'] = $id;
$this->functionData['uploadForm'][$count_b66c92b672a22027f37ff73d252eef90]['forum_id'] = $forum_id;
}
