...
{
$count_1c36fa2d4ae93a316de9910ab0a419af = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_1c36fa2d4ae93a316de9910ab0a419af]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_1c36fa2d4ae93a316de9910ab0a419af]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_1c36fa2d4ae93a316de9910ab0a419af]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_1c36fa2d4ae93a316de9910ab0a419af]['extraData'] = $extraData;
}
...
{
$count_158779d26d71ebe692be22c08c6a0991 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['formField'] = $formField;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['content'] = $content;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['options'] = $options;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_158779d26d71ebe692be22c08c6a0991]['showEditor'] = $showEditor;
}
...
{
$count_b6692f2334bcc46ad3807992c24d3c23 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_b6692f2334bcc46ad3807992c24d3c23]['options'] = $options;
$this->functionData['editorLoadJs'][$count_b6692f2334bcc46ad3807992c24d3c23]['inlineLoad'] = $inlineLoad;
}
...
{
$count_e29932937c9ef1f082a2a1e8eedcce9b = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_e29932937c9ef1f082a2a1e8eedcce9b]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_e29932937c9ef1f082a2a1e8eedcce9b]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_e29932937c9ef1f082a2a1e8eedcce9b]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_e29932937c9ef1f082a2a1e8eedcce9b]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__e0dcf0b9c004cd9e4a15c2b23b179119($rows,$pages,$app,$plugin)."		") : ("
...
function __f__e0dcf0b9c004cd9e4a15c2b23b179119($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_e10d49449ba9ac3fc29e50767ced5657 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_e10d49449ba9ac3fc29e50767ced5657]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__de1f97d451d1fb0b12d7d26cf0ac0458($tabs)."			</ul>
		</div>
...
function __f__de1f97d451d1fb0b12d7d26cf0ac0458($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
