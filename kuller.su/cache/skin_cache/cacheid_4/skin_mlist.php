...
{
$count_118f1ae61f044ec2d6d18c6c1d3b760e = is_array($this->functionData['member_alpha_ru']) ? count($this->functionData['member_alpha_ru']) : 0;
$this->functionData['member_alpha_ru'][$count_118f1ae61f044ec2d6d18c6c1d3b760e]['url'] = $url;
}
$IPBHTML .= "<li id='alpha_switch' class='clickable'>РУС</li>
		</ul>
	</div>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs_ru'>
		<ul>
    		...
    		")) . "
    ".$this->__f__0e62b71f629677215c211494ebb62c71($url)."            <li id='alpha_switch_en' class='clickable'>АНГ</li>";
return $IPBHTML;
}


function __f__0e62b71f629677215c211494ebb62c71($url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array('А','Б','В','Г','Д','Е','Ё','Ж','З','И','Й','К','Л','М','Н','О','П','Р','С','Т','У','Ф','Х','Ц','Ч','Ш','Щ','Ъ','Ы','Ь','Э','Ю','Я') as $char )
	{
		
		$__iteratorCount++;
		$_ips___x_retval .= "
    	" . (($letter=urlencode($char)) ? ("<li " . (($this->request['quickjump'] AND ($this->request['quickjump'] == $letter OR $this->request['quickjump'] == $char)) ? ("class='active'") : ("")) . "><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$url}&amp;quickjump={$letter}", "public",'' ), "false", "members_list" ) . "' title='{$this->lang->words['mlist_view_start_title']} {$char}'>{$char}</a></li>") : ("")) . "
...
{
$count_86da3778cebdf220afd043407f414f10 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_86da3778cebdf220afd043407f414f10]['members'] = $members;
$this->functionData['member_list_show'][$count_86da3778cebdf220afd043407f414f10]['pages'] = $pages;
$this->functionData['member_list_show'][$count_86da3778cebdf220afd043407f414f10]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_86da3778cebdf220afd043407f414f10]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_86da3778cebdf220afd043407f414f10]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_86da3778cebdf220afd043407f414f10]['url'] = $url;
}
...
" . (($this->settings['pp_allow_member_rate']) ? ("<li class='field'>
			...
			" . ((count( $custom_fields->out_fields )) ? ("
				".$this->__f__55ca79fbfb69263f49e8af7ffcd52d8c($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			") : ("")) . "			
		</ul>
		<ul id='filters_2'>
			<li class='field'>
		...
		<fieldset class='other_filters'>
			<select name='filter' class='input_select'>
				".$this->__f__7dc6806fd1dd4c3604b146f21326221c($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_by']}
			<select name='sort_key' class='input_select'>
				".$this->__f__11d6616ad1dfee8e640e283b61c8c3ae($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_in']}
			<select name='sort_order' class='input_select'>
				".$this->__f__85b646ded3201b17dd71cc9998004e48($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_with']}
			<select name='max_results' class='input_select'>
				".$this->__f__5687330645a7c7b2f667f50233e84b02($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
	...
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs'>
		<ul>
			...
			") : ("
				<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "members_list" ) . "' title='{$this->lang->words['mlist_view_all_title']}'>{$this->lang->words['mlist_view_all_txt']}</a></li>
			")) . "
			".$this->__f__0a8e9ab946838281e87b0e146c1de42e($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."		</ul>
	</div>
	<div class='ipsVerticalTabbed_content ipsLayout_content'>
		<div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__a35f67c3611850c2734279ab2704c05d($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."				") : ("
...
function __f__55ca79fbfb69263f49e8af7ffcd52d8c($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7dc6806fd1dd4c3604b146f21326221c($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__11d6616ad1dfee8e640e283b61c8c3ae($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__85b646ded3201b17dd71cc9998004e48($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5687330645a7c7b2f667f50233e84b02($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0a8e9ab946838281e87b0e146c1de42e($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a35f67c3611850c2734279ab2704c05d($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
