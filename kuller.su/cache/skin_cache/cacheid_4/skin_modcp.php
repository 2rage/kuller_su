...
{
$count_55f42afc4c3b512b26e6516d95773008 = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_55f42afc4c3b512b26e6516d95773008]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_55f42afc4c3b512b26e6516d95773008]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_55f42afc4c3b512b26e6516d95773008]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__72c411337faf0467f803a1b41bc594c8($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__72c411337faf0467f803a1b41bc594c8($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1161c8269d3f12d3bcf2b55582446e00 = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_1161c8269d3f12d3bcf2b55582446e00]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_1161c8269d3f12d3bcf2b55582446e00]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_1161c8269d3f12d3bcf2b55582446e00]['pagelinks'] = $pagelinks;
}
...
{
$count_73862d28b0b15cf754e5b1f8aae73f03 = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_73862d28b0b15cf754e5b1f8aae73f03]['profile'] = $profile;
$this->functionData['editUserForm'][$count_73862d28b0b15cf754e5b1f8aae73f03]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__28a5834ff21707aa8b02dc664bfb3690($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__28a5834ff21707aa8b02dc664bfb3690($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4266b4de1aaafb2e95e0c55d79313c64 = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_4266b4de1aaafb2e95e0c55d79313c64]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_4266b4de1aaafb2e95e0c55d79313c64]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__6a1b2d91e0451b2c8d1474e30af686ac($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__6a1b2d91e0451b2c8d1474e30af686ac($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0eaa6f6c26b4bba4db7fcb4af0f1d2ca = is_array($this->functionData['memberLookup']) ? count($this->functionData['memberLookup']) : 0;
}
...
{
$count_67a3a02a5a6d9c20216f0653567aeb23 = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_67a3a02a5a6d9c20216f0653567aeb23]['type'] = $type;
$this->functionData['membersList'][$count_67a3a02a5a6d9c20216f0653567aeb23]['members'] = $members;
$this->functionData['membersList'][$count_67a3a02a5a6d9c20216f0653567aeb23]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__6ed9cf6a971f032cf6f590a17755ae64($type,$members,$pagelinks)."				") : ("
...
function __f__6ed9cf6a971f032cf6f590a17755ae64($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_160275dfff23d86d9735f65824f17ded = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_160275dfff23d86d9735f65824f17ded]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_160275dfff23d86d9735f65824f17ded]['inlineMsg'] = $inlineMsg;
}
...
{
$count_d4a33776f07a60c1fda2cce08b1f795c = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_d4a33776f07a60c1fda2cce08b1f795c]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_d4a33776f07a60c1fda2cce08b1f795c]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__84626619b99b3d8a7661e0b653d7d6c9($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__84626619b99b3d8a7661e0b653d7d6c9($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a889be53fb0c84e3b298c0990c91208a = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_a889be53fb0c84e3b298c0990c91208a]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_a889be53fb0c84e3b298c0990c91208a]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_a889be53fb0c84e3b298c0990c91208a]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__fcbd2b7fa77e27a1f498a4529f8d318e($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__fcbd2b7fa77e27a1f498a4529f8d318e($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_84f3c870853252e1606302abace53802 = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_84f3c870853252e1606302abace53802]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_84f3c870853252e1606302abace53802]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_84f3c870853252e1606302abace53802]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_84f3c870853252e1606302abace53802]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_84f3c870853252e1606302abace53802]['msg'] = $msg;
}
...
{
$count_2c03ffdac59dd519da23cd84eab24d1f = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_2c03ffdac59dd519da23cd84eab24d1f]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__367d46aca7a44f4152daecc24361c813($announcements)."		") : ("
			<tr>
...
function __f__c8b84acc4ed13d92c126ea5f9a4449ed($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__367d46aca7a44f4152daecc24361c813($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__c8b84acc4ed13d92c126ea5f9a4449ed($announcements,$announce)."									</ul>
								") : ("
...
{
$count_5ce7099aafd9da82e190dd3951ac5932 = is_array($this->functionData['modControls']) ? count($this->functionData['modControls']) : 0;
$this->functionData['modControls'][$count_5ce7099aafd9da82e190dd3951ac5932]['editmember'] = $editmember;
$this->functionData['modControls'][$count_5ce7099aafd9da82e190dd3951ac5932]['warnpanel'] = $warnpanel;
$this->functionData['modControls'][$count_5ce7099aafd9da82e190dd3951ac5932]['warnlogs'] = $warnlogs;
$this->functionData['modControls'][$count_5ce7099aafd9da82e190dd3951ac5932]['noteForm'] = $noteForm;
$this->functionData['modControls'][$count_5ce7099aafd9da82e190dd3951ac5932]['return'] = $return;
}
...
{
$count_5025a8c53b17dc12e72680b5f3d8c8d0 = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_5025a8c53b17dc12e72680b5f3d8c8d0]['message'] = $message;
}
...
{
$count_01f2d0256a368e71688e1be591852251 = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_01f2d0256a368e71688e1be591852251]['post'] = $post;
$this->functionData['modCPpost'][$count_01f2d0256a368e71688e1be591852251]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_01f2d0256a368e71688e1be591852251]['topic'] = $topic;
$this->functionData['modCPpost'][$count_01f2d0256a368e71688e1be591852251]['type'] = $type;
}
...
{
$count_063f428e9af0a3feb1c7c666e42c95d2 = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_063f428e9af0a3feb1c7c666e42c95d2]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_063f428e9af0a3feb1c7c666e42c95d2]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_063f428e9af0a3feb1c7c666e42c95d2]['type'] = $type;
$this->functionData['modCPtopic'][$count_063f428e9af0a3feb1c7c666e42c95d2]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__c575c693c6b3e56f9b724e267113036d($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__ddc08d50e67a0c59e6936996fb83647d($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c575c693c6b3e56f9b724e267113036d($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__ddc08d50e67a0c59e6936996fb83647d($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_c56699f935649a47b4997eaacb5eef33 = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_c56699f935649a47b4997eaacb5eef33]['output'] = $output;
$this->functionData['portalPage'][$count_c56699f935649a47b4997eaacb5eef33]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_c56699f935649a47b4997eaacb5eef33]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__0acd84b413e7f130afad525f229dcc6d($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__0acd84b413e7f130afad525f229dcc6d($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f1fc045a8f159a935db076ff883c2157 = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__1a61ad51b93c42d24ac131607b30388f()."";
return $IPBHTML;
}


function __f__cd7bbdbb56e97cc3f96145b7312042f3($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1a61ad51b93c42d24ac131607b30388f()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__cd7bbdbb56e97cc3f96145b7312042f3($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_71b77f3e0c91b470536f13e0f524797a = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_71b77f3e0c91b470536f13e0f524797a]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_71b77f3e0c91b470536f13e0f524797a]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__ab20ad0f95ae8589d81deb0323253258($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__ab20ad0f95ae8589d81deb0323253258($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_6264df70331c5e6466392a15a702bda3 = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_6264df70331c5e6466392a15a702bda3]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_6264df70331c5e6466392a15a702bda3]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
...
{
$count_33c090f7d987ec03f4015d04521dccd6 = is_array($this->functionData['warn_view_log']) ? count($this->functionData['warn_view_log']) : 0;
$this->functionData['warn_view_log'][$count_33c090f7d987ec03f4015d04521dccd6]['member'] = $member;
$this->functionData['warn_view_log'][$count_33c090f7d987ec03f4015d04521dccd6]['rows'] = $rows;
$this->functionData['warn_view_log'][$count_33c090f7d987ec03f4015d04521dccd6]['links'] = $links;
}
...
$IPBHTML .= "" . (($this->request['module']=='ajax') ? ("
	...
	") : ("")) . "
		<table class='ipb_table'>
			...
			") : ("
								".$this->__f__16d7164aaf2bbb8a15740b0710230777($member,$rows,$links)."			")) . "
		</table>
...
function __f__16d7164aaf2bbb8a15740b0710230777($member, $rows, $links='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_f62544f31ecbdb7d4513f231d81ac4f4 = is_array($this->functionData['warnForm']) ? count($this->functionData['warnForm']) : 0;
$this->functionData['warnForm'][$count_f62544f31ecbdb7d4513f231d81ac4f4]['member'] = $member;
$this->functionData['warnForm'][$count_f62544f31ecbdb7d4513f231d81ac4f4]['errors'] = $errors;
$this->functionData['warnForm'][$count_f62544f31ecbdb7d4513f231d81ac4f4]['modque'] = $modque;
$this->functionData['warnForm'][$count_f62544f31ecbdb7d4513f231d81ac4f4]['postque'] = $postque;
$this->functionData['warnForm'][$count_f62544f31ecbdb7d4513f231d81ac4f4]['ban'] = $ban;
$this->functionData['warnForm'][$count_f62544f31ecbdb7d4513f231d81ac4f4]['editor_html'] = $editor_html;
}
