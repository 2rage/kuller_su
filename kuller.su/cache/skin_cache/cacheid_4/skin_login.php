...
{
$count_244d79908091f83ef1ca3873e68490e9 = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
{
$count_ca32416d214a5d56365d5a11b42a6706 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_ca32416d214a5d56365d5a11b42a6706]['message'] = $message;
$this->functionData['showLogInForm'][$count_ca32416d214a5d56365d5a11b42a6706]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_ca32416d214a5d56365d5a11b42a6706]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_ca32416d214a5d56365d5a11b42a6706]['login_methods'] = $login_methods;
$this->functionData['showLogInForm'][$count_ca32416d214a5d56365d5a11b42a6706]['facebookOpts'] = $facebookOpts;
}
			...
			<div id='regular_signin'>
				...
				<div class='right ipsPad_double' id='other_signin'>
					<ul class='ipsList_data clear ipsType_small'>
						...
						") : ("")) . "<!--hook.if.skin_login.showLogInForm.twitterBox.post.endif-->
						" . ((IPSLib::loginMethod_enabled('live')) ? ("
						...
						" . ((is_array($extra_form) AND count($extra_form)) ? ("
							".$this->__f__a7a02882ea8f01f4dc7ffe6acf67d804($message,$referer,$extra_form,$login_methods,$facebookOpts)."						") : ("")) . "
					</ul>
				</div>
			</div>
			" . ((IPSLib::loginMethod_enabled('live')) ? ("
...
function __f__a7a02882ea8f01f4dc7ffe6acf67d804($message="",$referer="",$extra_form="", $login_methods=array(), $facebookOpts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
