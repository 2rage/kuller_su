...
{
$count_6d47ee40819c9f45bde7df99760db48c = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_49d059a5238e229a54ec243973bd0738 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_49d059a5238e229a54ec243973bd0738]['html'] = $html;
$this->functionData['messengerTemplate'][$count_49d059a5238e229a54ec243973bd0738]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_49d059a5238e229a54ec243973bd0738]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_49d059a5238e229a54ec243973bd0738]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_49d059a5238e229a54ec243973bd0738]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_49d059a5238e229a54ec243973bd0738]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_49d059a5238e229a54ec243973bd0738]['deletedTopic'] = $deletedTopic;
}
...
<div id='messenger_utilities' class='left'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("<div class='ipsSideBlock' id='participants'>
			...
			<ul id='participants_list' class='ipsList_withminiphoto fullList'>
				".$this->__f__404d3ab9e44e9e25cd126e4382d76512($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."					
			</ul>
	...
	<div id='folder_list' class='ipsSideBlock'>
		...
		<ol id='folders'>
			" . ((count($dirData)) ? ("
				".$this->__f__b8af52a244452b68e7d39e5c7d2d93b9($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."			") : ("")) . "
		</ol>
...
function __f__404d3ab9e44e9e25cd126e4382d76512($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b8af52a244452b68e7d39e5c7d2d93b9($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9ffa163f2729d50fdbbaabd91c2a5254 = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_9ffa163f2729d50fdbbaabd91c2a5254]['displayData'] = $displayData;
}
...
<div class='message error'>
	...
	".$this->__f__d39621a42e92d1c82fc90f007ecb1ce6($displayData)."	<p>{$this->lang->words['pme_none_sent']}</p>
</div>
</div>
") : ("")) . "
...
function __f__d39621a42e92d1c82fc90f007ecb1ce6($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_617094614c5049d77dad34626bb13bcc = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_617094614c5049d77dad34626bb13bcc]['displayData'] = $displayData;
}
$IPBHTML .= "<div id='message_compose' class='post_form'>
...
<div class='message error'>
    <h4>{$this->lang->words['err_errors']}</h4>
    ".$this->__f__9ed678bd4bb1c33de118371e7a274e60($displayData)."    <p>{$this->lang->words['pme_none_sent']}</p>
</div><br />
") : ("")) . "
...
function __f__9ed678bd4bb1c33de118371e7a274e60($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_43e4da01ad5cfe16137490c0281b54e7 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_43e4da01ad5cfe16137490c0281b54e7]['topic'] = $topic;
$this->functionData['showConversation'][$count_43e4da01ad5cfe16137490c0281b54e7]['replies'] = $replies;
$this->functionData['showConversation'][$count_43e4da01ad5cfe16137490c0281b54e7]['members'] = $members;
$this->functionData['showConversation'][$count_43e4da01ad5cfe16137490c0281b54e7]['jump'] = $jump;
}
...
<div class='ipsBox removeDefault'>
	<div class='ipsBox_container'>
		".$this->__f__83fb41c700b45fe3f68dd08720bcc147($topic,$replies,$members,$jump)."	</div>
</div>" . $this->registry->getClass('output')->getReplacement("box_end") . "
...
function __f__83fb41c700b45fe3f68dd08720bcc147($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<div class='post_block first hentry column_view' id='post_id_{$msg['msg_id']}'>
				<div class='post_wrap'>
					...
					")) . "
							...
							")) . "</div><div class='post_date'>{$this->lang->words['pc_sent']} " . $this->registry->getClass('class_localization')->getDate($msg['msg_date'],"long", 0) . "</div>
...
{
$count_ca7f0cbdab17a8f31e16e4c7c880457e = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_ca7f0cbdab17a8f31e16e4c7c880457e]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_ca7f0cbdab17a8f31e16e4c7c880457e]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_ca7f0cbdab17a8f31e16e4c7c880457e]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__434103982477629692b413b2d51a3cb1($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__434103982477629692b413b2d51a3cb1($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_cd96b56d427b6f416b76427398959ade = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_cd96b56d427b6f416b76427398959ade]['messages'] = $messages;
$this->functionData['showFolder'][$count_cd96b56d427b6f416b76427398959ade]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_cd96b56d427b6f416b76427398959ade]['pages'] = $pages;
$this->functionData['showFolder'][$count_cd96b56d427b6f416b76427398959ade]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_cd96b56d427b6f416b76427398959ade]['jumpFolderHTML'] = $jumpFolderHTML;
}
		...
		<div class='ipsBox removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' id='message_table'>
					...
					" . ((count( $messages )) ? ("
						".$this->__f__42bc849778ba925a097e749d117998d4($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."					") : ("
						<tr>
...
function __f__5a15128c5e257b7c979b9a8e53b86be4($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML,$id='',$msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__42bc849778ba925a097e749d117998d4($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							<tr id='{$msg['mt_id']}' class='" . (($msg['map_has_unread']) ? ("unread") : ("")) . "'>
								...
								<td class='col_m_subject'>
									...
									" . ((is_array( $msg['pages'] ) AND count( $msg['pages'] )) ? ("
										...
										".$this->__f__5a15128c5e257b7c979b9a8e53b86be4($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML,$id,$msg)."										</ul>
									") : ("")) . "
								</td>
...
{
$count_f27beaac8ed584e7aa4be717d12fec5c = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_f27beaac8ed584e7aa4be717d12fec5c]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_f27beaac8ed584e7aa4be717d12fec5c]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_f27beaac8ed584e7aa4be717d12fec5c]['error'] = $error;
}
$IPBHTML .= "<script type='text/javascript'>
//<![CDATA[
	...
	<div class='ipsBox removeDefault'>
		<div class='ipsBox_container'>
			<table class='ipb_table' id='message_table'>
				...
				" . ((count( $messages )) ? ("
					".$this->__f__205c6a43e4f52e84b3173964cde66eae($messages,$pages,$error)."				") : ("
					<tr>
...
function __f__205c6a43e4f52e84b3173964cde66eae($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
