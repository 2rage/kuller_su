...
Отписаться:
--------------
Вы можете управлять своими подписками в данной секции форума: <#UNSUBCRIBE_URL#>",
'email_convo' => "<#NAME#>,
...
'subject__subs_new_topic' => "<#POSTER#> создал тему <a href='<#URL#>'><#TITLE#></a>",
'subject__subs_with_post' => "<#POSTER#> ответил в тему <a href='<#URL#>'><#TITLE#></a>",
